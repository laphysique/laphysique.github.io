...
\item {\bf 17} scientific papers in peer-reviewed journals of, cumulatively cited {\bf over 900} times
...
\vspace{-0.7em} \\
\begin{itemize}[leftmargin=*]\itemsep-0.2em
\item In charge of the computational biophysics methods for proprietary computer-aided drug design (CADD) platform
\item Coding in C, Python, and Cython to establish the architecture and contents of the CADD platform 
%
...
{\it J Mol Biol} DOI: 10.1016/j.jmb.2022.167515
($^*$equal contribution)
