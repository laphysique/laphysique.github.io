...
\item {\bf 20} scientific papers in peer-reviewed journals cumulatively cited {\bf over 2000} times
...
%
\item{\bf Tools:}
Numpy, Scipy, Pandas/Polars, Matplotlib, Scikit-Learn, PyTorch, PyMC, SQLite, MPI, Git
