...
\item {\bf 16} scientific papers in peer-reviewed journals of, cumulatively cited {\bf over 900} times
...
\vspace{-0.7em} \\
\begin{itemize}[leftmargin=*]\itemsep-0.2em
\item Developing proprietary molecular dynamics force fields with new features for pharmaceutical applications
\item Incorporating machine learning to optimizing molecular dynamics simulation performance
\item Implementing mathematical physics methods to validate the simulation methods
\item Attended due diligence meetings with potential investors to provide scientific consultation.
\end{itemize}
